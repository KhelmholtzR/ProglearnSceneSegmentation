#================================================================
# Scene Segmentation, Proglearn Issue 39
# Neuro Data Design I: Fall 2021
#================================================================

# These functions are implemented for use in proglearn-tree.ipynb

# to be modified: these are taken from FTE_MNIST and will be altered accordingly
...
def train_forest(x_data, y_data, num_tasks, num_points_per_task, ntrees, reps):
    """
    trains Proglearn Lifelong Classification Forest on provided data
    """
